...
public final class CometChatGroupEvents: ObservableObject {
    ...
    // MARK: - Singleton
    public static let shared = CometChatGroupEvents()
    private init() {}
    
    // MARK: - Emitters (modern API)
    ...
    @available(*, deprecated, message: "Use ccGroupLeft(...) instead")
    ...
    public func emitOnGroupMemberUnban(unbannedUserUser: User, unbannedUserGroup: CCGroup, unbannedBy: User) {
        lastGroup = unbannedUserGroup
        lastEvent = "Member Unbanned (Deprecated)"
        onGroupMemberUnbanLegacy?(unbannedUserUser, unbannedUserGroup, unbannedBy)
    }
    ...
    public func emitOnGroupMemberAdd(group: CCGroup, members: [GroupMember], addedBy: User) {
        lastGroup = group
        lastEvent = "Member Added (Deprecated)"
